...
(function($){$(function () {
	...
	$('form.wpallimport-template:visible').find('.repeater').find('.add-row-end').on('click', function(){
	...
	$('.add_layout_button').on('click', function(){
	...
	$('.delete_layout_button').on('click', function(){
